...
const CATEGORIES = ["drinks", "food", "snacks", "specials"] as const;
const ADMIN_PASSWORD = process.env.NEXT_PUBLIC_ADMIN_PASSWORD || "morokot2024!";
    ...
    return (
      <div style={{ ...S.page, display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh" }}>
        <div style={{ ...S.card, width: 400, textAlign: "center" }}>
          ...
          <p style={{ color: "#9e9289", fontSize: "0.85rem", marginBottom: "2rem" }}>Morokot Cafe — Menu Manager</p>
        ...
        <div style={S.card}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: showForm ? "1.8rem" : 0 }}>
            ...
            <div style={{ display: "flex", gap: "0.8rem" }}>
              ...
              {!editingId && (
                <button onClick={() => { if (showForm) { resetForm(); } else { setShowForm(true); } }} style={{ ...S.btnPrimary, ...(showForm ? S.btnGhost : {}) }}>
          ...
          {(showForm || editingId) && (
            <div>
              <div className="admin-2col" style={{ marginBottom: "1.2rem" }}>
                <div>
                  <label style={S.label}>Item Name *</label>
                  <input style={S.input} placeholder="e.g. Half Morokot Cafe" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
                </div>
                <div>
